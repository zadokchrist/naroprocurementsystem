<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Requisition_AreaPDUViewItems.aspx.cs" Inherits="Requisition_AreaPDUViewItems" Title="AREA PDU - MANAGE REQUISITION(S)" %>
     ...
     <table cellpadding="0" cellspacing="0" class="style12">
        ...
        <tr>
            <td style="vertical-align: top; width: 50%; text-align: center">
                ...
                <asp:Label ID="lblPD_Code" runat="server" Text="0"></asp:Label></td>
        </tr>
    </table>
