...
using System.IO;
public partial class Planning_Procu : System.Web.UI.Page
{
    ...
    private void LoadItems()
    {
        ...
        dtable = Process.GetPMPlanItems(Search, ProcTypeCode, CostCenterID);
    }
    ...
    private void SubmitPlanItems()
    {
        ...
        else
        {
            ...
            if (ItemArr != "")
            {
                ...
                {
                    case 0:
                        returned = Process.SubmitPlanItemsByProcManager(ItemArr, 103, txtComment.Text);
                        break;
                    case 1:
                        returned = Process.SubmitPlanItemsByProcManager(ItemArr, 7, txtComment.Text);
                        break;
                    default:
