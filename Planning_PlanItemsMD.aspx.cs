...
using System.IO;
public partial class Planning_PlanItemsMD : System.Web.UI.Page
{
    ...
    private void LoadItems()
    {
        ...
        dtable = Process.GetMDPlanItems(Search, ProcTypeCode, QuarterID, CostCenterID);
                ...
                if (ItemArr != "")
                {
                    ...
                    switch (rbnApproval.SelectedIndex)
                    {
                        case 0:
                            ...
                            //else
                                returned = Process.SubmitPlanItemsForApproval(ItemArr, 8, txtComment.Text);
                            break;
                        case 1:
