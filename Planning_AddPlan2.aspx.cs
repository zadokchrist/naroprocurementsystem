...
public partial class Planning_AddPlan2 : System.Web.UI.Page
{
    ...
    private void ValidateDetails()
    {
        ...
        else
        {
            ...
            string returned = Process.SavePlan(PlanCode, ProcType, ProcMethod, FinCode, IsOperational, IsStock, StockCode, StockItemName, "",
                ...
                UnitCost, Qty, QuarterCode, Date4PP20, DateNeeded, PayPeriod, PaymentMonth, ProcLength, Planner, Planned, MarketPrice, IsFrameWork);
