...
public partial class Planning_ExpectedExpenditure : System.Web.UI.Page
{
    ...
    private void DownloadReport()
    {
        ...
        dataTable = Process.GetExpectedExpenditure(FinancialYearCode, CostCenter);
    ...
    private void LoadReport()
    {
        ...
        dataTable = Process.GetExpectedExpenditure(FinancialYearCode, CostCenter);
        ExpectedExpetiture.DataSource = dataTable;
        ExpectedExpetiture.DataBind();
    ...
    private void PrintReport()
    {
        ...
        //doc.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, true, "ConsolidatedPlan");
    }
    ...
    protected void GridCCenter_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        try
        {
            ...
            ExpectedExpetiture.PageIndex = newPageIndex;
        }
        catch (Exception ex)
        {
            ShowMessage(ex.Message);
