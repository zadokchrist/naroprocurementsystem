<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="BidEvaluationApproval.aspx.cs" Inherits="Requisition_ApproveActivitySchedule" Title="Approve Activity Schedule" %>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                <asp:Button ID="Button1" runat="server" OnClick="btnReturn_Click" Text="Return" class="btn btn-primary btn-user btn-block float-right"/>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                <asp:DropDownList ID="cboPDUHead" runat="server" CssClass="form-control"
                    OnDataBound="cboPDUHead_DataBound" Enabled="false">
                </asp:DropDownList>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                <asp:TextBox ID="txtBidStartDate" runat="server" autocomplete="off" Font-Bold="True" ForeColor="" CssClass="form-control" Enabled="false"></asp:TextBox>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-1 mb-3 mb-sm-0"></div>
        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="1">
            ...
            <asp:View ID="View2" runat="server">
                ...
                <div class="form-group row">
                    <div class="col-sm-1 mb-3 mb-sm-0"></div>
                    <div class="col-sm-2 mb-3 mb-sm-0">Approve Evaluation</div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
