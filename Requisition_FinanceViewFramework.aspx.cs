...
public partial class Requisition_FinanceViewItems : System.Web.UI.Page
{
    ...
    private void LoadItems()
    {
        ...
        datatable = Process.GetAllCentersRequisitionItemsFramework(RecordID, ProcType, StartDate, EndDate, Status, AreaCode, CostCenterCode);
        ...
        else
        {
            ...
            string EmptyMessage = "No New FRAMEWORK Requisition in the system from Cost Center (" + cboCostCenters.SelectedItem+")" + Environment.NewLine;
    ...
    protected void DataGrid1_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.CommandName == "btnAction")
            {
                ...
                Response.Redirect("Requisition_finance_framework.aspx?transferid=" + RecordID, true);
            }
