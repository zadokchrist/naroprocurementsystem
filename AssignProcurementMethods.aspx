<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="AssignProcurementMethods.aspx.cs" Inherits="Requisition_InventoryViewItems" Title="VIEW REQUISITION(S)" %>
    ...
    <div class="card shadow mb-4">
        <div class="form-group row">
            ...
            <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <h6 class="m-0 font-weight-bold text-primary">ASSIGN PROCUREMENTS APPROVED BY MD</h6>
            </div>
            </div>
        </div>
        <div class="form-group row">
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td class="InterFaceTableLeftRowUp" style="width: 100%; text-align: center">
                                                ACTIVITY ITEMS SENT TO YOU FOR ASSIGNEMENT</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width: 100%">
                                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4" Font-Names="Verdana" Font-Size="Small"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="TotalAmount" HeaderText="Est. Cost" DataFormatString="{0:N0}">
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="MarketPrice" HeaderText="Market Price" Visible="false" DataFormatString="{0:N0}">
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundColumn>
