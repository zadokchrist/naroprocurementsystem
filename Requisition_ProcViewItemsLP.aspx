<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="Requisition_ProcViewItemsLP.aspx.cs" Inherits="Requisition_ProcViewItemsLP" Title="VIEW REQUISITION(S)" %>
                                            ...
                                            <td style="width: 100%">
                                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4" Font-Names="Verdana" Font-Size="Small"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="TotalAmount" HeaderText="Market Price" Visible="false" DataFormatString="{0:N0}">
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundColumn>
