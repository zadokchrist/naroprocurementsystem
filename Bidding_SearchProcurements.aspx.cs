...
public partial class Bidding_ScheduledProcurements : System.Web.UI.Page
{
    ...
    private void LoadItems()
    {
        ...
        int status = int.Parse(cboStatus.SelectedValue);
        datatable = Process.SearchProcurements(RecordID, PrNumber, ProcOfficer, ProcMethod, AreaCode, CostCenterCode, status);
