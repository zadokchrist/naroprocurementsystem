<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="Bidding_MDItems.aspx.cs" Inherits="Bidding_MDItems" Title="PROCUREMENT(S) PENDING FOR Procurement Supervisor REVIEW" %>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 60%">
                    <tr>
                        <td class="InterfaceHeaderLabel3" style="height: 18px">
                            PROCUREMENT(S) PENDING FOR MD REVIEW </td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 95%">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle; width: 17%; height: 23px; text-align: center">
                          ...
                          <td style="vertical-align: middle; width: 17%; height: 23px; text-align: center">
                            <asp:DropDownList ID="ddllStatus" runat="server" CssClass="InterfaceDropdownList"
                                 Width="95%">
                                <asp:ListItem Text="Draft EOI submitted" Value="35"></asp:ListItem>
                                <asp:ListItem Text="EOI evaluation submitted" Value="40"></asp:ListItem>
                                <asp:ListItem Text="Method, Docs & Bidders submitted" Value="43"></asp:ListItem>
                                 <asp:ListItem Text="Technical Evaluation submitted" Value="57"></asp:ListItem>
                                  <asp:ListItem Text="Financial & Technical Evaluation submitted" Value="66"></asp:ListItem>
                            </asp:DropDownList></td>
                        <td style="vertical-align: middle; width: 17%; height: 23px; text-align: center">
                                                ...
                                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4"  Font-Names="Verdana" Font-Size="Small"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateColumn HeaderText="ACTION" >
                                                            <ItemTemplate>
                                                                <asp:LinkButton runat="server" ID="btnDetails" CommandName="btnViewDetails" Text="Review &amp; Submit"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                                ...
                                                                ID="lblRefNo" runat="server" Text="0" Visible="False"></asp:Label><asp:Label ID="lblQuestionCount"
                                                                    runat="server" Text="0" Visible="False"></asp:Label><asp:Label ID="lblCost" runat="server"
                                                                        Text="0" Visible="False"></asp:Label><asp:Label ID="lblPDCode" runat="server" Text="0"
                                                                            ...
                                                                            <asp:Label ID="lblpreviousstatus" runat="server" Text="0"
                                                                            Visible="False"></asp:Label>
                                                ...
                                                <table align="center" cellpadding="0" cellspacing="0" style="width: 95%">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <tr>
                                                        ...
                                                        <td class="InterFaceTableRightRowUp" style="width: 66%">
                                                            <asp:TextBox ID="txtBidStart" runat="server" BorderStyle="Solid" CssClass="InterfaceTextboxLongReadOnly"
                                                                Font-Bold="True" ReadOnly="True" Width="90%"></asp:TextBox></td>
                                                    </tr>
                                                     <tr>
                                                        <td class="InterFaceTableLeftRowUp">
                                                        ...
                                                        <td class="InterFaceTableRightRowUp" style="width: 66%">
                                                            <asp:TextBox ID="txtBidCloseDate" runat="server" BorderStyle="Solid" CssClass="InterfaceTextboxLongReadOnly"
                                                                Font-Bold="True" ReadOnly="True" Width="90%"></asp:TextBox></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td colspan="4" style="vertical-align: top; width: 50%; text-align: center">
                                                <table align="center" cellpadding="0" cellspacing="0" style="width: 95%">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                                <td class="InterFaceTableLeftRowUp">
                                                                    <asp:Label runat="server" ID="lblContractNumber" Text="Contract Number"></asp:Label> </td>
                                                                <td class="InterFaceTableMiddleRowUp">
                                                                </td>
                                                                <td class="InterFaceTableRightRowUp" style="width: 66%">
                                                                    <asp:TextBox ID="txtContractNumber" runat="server" BorderStyle="Solid" CssClass="InterfaceTextboxLongReadOnly"
                                                                        Font-Bold="True" ReadOnly="True" Width="90%"></asp:TextBox></td>
                                                            </tr>
                                                </table>
                                            </td>
                                            ...
                                            <td colspan="4" style="vertical-align: top; position: static; height: 5px; text-align: center">
                                                &nbsp;<asp:MultiView ID="MultiView2" runat="server">
                                                    <asp:View ID="View9" runat="server"><table style="width: 100%">
                                                        ...
                                                        <tr>
                                                            <td style="width: 100%; text-align: center">
                                                <asp:Button ID="btnFormDetails" runat="server" Text="View Form Details" 
                                                                    OnClick="btnFormDetails_Click" style="height: 26px" Visible="false" /><asp:Button ID="btnViewBidders" runat="server" Text="View Shortlisted Bidders" OnClick="btnViewBidders_Click" /><asp:Button ID="btnViewEC"  Visible="false" runat="server" Text="View EC Members" OnClick="btnViewEC_Click" />
                                                                <asp:Button ID="btnViewSolDocs" runat="server" Text="View Sol. Docs" OnClick="btnViewSolDocs_Click" />
                                                                <asp:Button ID="btnAwardContract" runat="server" Visible="false" OnClick="btnAwardContract_Click"  Text="View Letter of Contract Award" />
                                                            <asp:Button ID="btnEval" runat="server" Text="View Evaluation Details" Visible="false" OnClick="btnEval_Click" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 100%; text-align: center">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                Height="23px" OnClick="btnPrint_Click"  Enabled="false"  Text="Print" Width="120px" />
                                                    ...
                                                    <asp:View ID="View10" runat="server">
                                                       ...
                                                       <asp:View runat="server" ID="view11">
                                                        ...
                                                        <table style="width: 100%">
                                                            ...
                                                            <tr>
                                                                <td class="InterFaceTableLeftRowUp" colspan="3" style="width: 100%; text-align: center">EVALUATION DETAILS</td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3" style="width: 100%; height: 21px; text-align: center">
                                                                    ...
                                                                    <asp:DataGrid ID="dgvEval" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundColumn DataField="BidValue" HeaderText="Bid Amount"></asp:BoundColumn>
                                                                            <asp:BoundColumn DataField="discountOffered" HeaderText="Discount"></asp:BoundColumn>
