<%@ Page Language="C#" MasterPageFile="~/Suppliers.master" AutoEventWireup="true" CodeFile="Suppliers_Uploads.aspx.cs" Inherits="Requisition_PlannedItems" Title="ITEMS TO REQUISITION" %>
                                            ...
                                            <td style="width: 100%">
                                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4" HorizontalAlign="Left" Font-Names="Verdana" Font-Size="Small"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="Last Accessed" HeaderText="Last Accessed" DataFormatString="{0:N0}">
                                                            <ItemStyle Width="120px" HorizontalAlign="Left" />
                                                        </asp:BoundColumn>
                                                       
                                                        <asp:ButtonColumn CommandName="btnRequisition" HeaderText="Details"  Text="VIEW">
