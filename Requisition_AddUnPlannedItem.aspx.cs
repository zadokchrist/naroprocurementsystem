...
public partial class Planning_AddPlan : System.Web.UI.Page
{
    ...
    private void ValidateDetails()
    {
        ...
        else if (txtJustify.Text == "")
            ShowMessage("Please Enter Justification for the Unplanned Item");
        else
        {
            ...
            double Marketpricex = Convert.ToDouble(UnitCost);
            ...
            //string Date4PP20 = txtDate4PP20.Text.Trim();
            string DateNeeded = txtDateWhenNeeded.Text.Trim();
  ...
  //              throw new Exception("The Date When Needed is invalid. Please check against the Procurement Length.");
            ...
            string returned = Process.SavePlan(PlanCode, ProcType, ProcMethod, FinCode, IsOperational, IsStock, StockCode, StockItemName, "",
                ...
                UnitCost, Qty, QuarterCode, DateNeeded , DateNeeded, PayPeriod, "1", ProcLength, Planner, Planned, Marketpricex, IsFrameWork);
            ...
            if (returned.Contains("captured Successfully"))
            {
                ...
                else
                {
                    Toggle(false, ".");
                    //Response.Redirect("Requisition_Items.aspx?transferid=1", true);
                    ShowMessage("Requisition saved successfully and sent to cost center manager for approval");
                }
    ...
    {
        txtDescription.Text = ""; txtJustify.Text = "";
        //txtDate4PP20.Text = "";
        txtDateWhenNeeded.Text = "";
