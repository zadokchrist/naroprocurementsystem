...
using System.Text;
public partial class Requisition_ManagerViewItems : System.Web.UI.Page
{
    ...
    private void LoadItems()
    {
        ...
        if(Session["AccessLevelID"].ToString() == "24") //RPM
        {
            Status = "107";
        }else if (Session["AccessLevelID"].ToString() == "25") //RDM
        {
            Status = "115";
        } else if (Session["AccessLevelID"].ToString() == "26") //RCM
        {
            Status = "117";
        }
