<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="Requisition_ManagerViewItems.aspx.cs" Inherits="Requisition_ManagerViewItems" Title="REQUISITION ITEM(S)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="form-group row">
            <div class="col-sm-3 mb-3 mb-sm-0"></div>
            <div class="col-sm-10 mb-3 mb-sm-0"><asp:Label ID="lblPDCode" runat="server" Text="0" Visible="False"></asp:Label></div>
        </div>
    </div>
