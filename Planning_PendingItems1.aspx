<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Planning_PendingItems1.aspx.cs" Inherits="Planning_PendingItems" Title="PENDING PLAN ITEMS" %>
        ...
        <tr>
            ...
            <td style="vertical-align: middle; width: 17%; height: 23px; text-align: center">
                <asp:DropDownList ID="cboQuarter" runat="server" CssClass="InterfaceDropdownList"
                    OnDataBound="cboQuarter_DataBound" Width="95%">
                </asp:DropDownList></td>
            <td style="vertical-align: middle; width: 17%; height: 23px; text-align: center">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle; width: 50%; height: 30px; text-align: left">
                            &nbsp;<asp:DropDownList ID="cboTopAreaManagers" runat="server" OnDataBound="cboTopAreaManagers_DataBound"
                                Width="80%" AutoPostBack="True" OnSelectedIndexChanged="cboTopAreaManagers_SelectedIndexChanged1">
                            </asp:DropDownList></td>
