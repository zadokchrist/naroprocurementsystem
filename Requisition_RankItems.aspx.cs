...
using System.IO;
public partial class Requisition_RankItems : System.Web.UI.Page
{
    ...
    private void LoadItems()
    {
        ...
        datatable = Process.GetRankItems(RecordID, ProcType, StartDate, EndDate, Status, AreaCode, CostCenterCode);
    ...
    protected void DataGrid1_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "btnAction")
            {
                ...
                Response.Redirect("./Requisition_RankApproval.aspx?transferid=" + RecordID, true);
            }
