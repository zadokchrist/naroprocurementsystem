<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="ConfigureContract.aspx.cs" Inherits="AddWorkFlow" 
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            <asp:View ID="View1" runat="server">
                ...
                <div class="form-group row">
                    <div class="col-sm-3 mb-3 mb-sm-0"></div>
                    <div class="col-sm-6">
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" class="btn btn-primary btn-user btn-block float-right" Text="CONFIGURE CONTRACT" />
                    </div>
                </div>
                <div class="card-body">
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="WorkflowId" HeaderText="WorkflowId" Visible="false"></asp:BoundColumn>
