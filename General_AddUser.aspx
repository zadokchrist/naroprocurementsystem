<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="General_AddUser.aspx.cs" 
Inherits="AddUser" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
               <asp:DropDownList ID="cboAreas" runat="server" AutoPostBack="True" OnDataBound="cboAreas_DataBound" OnSelectedIndexChanged="cboAreas_SelectedIndexChanged" CssClass="form-control">
                                                </asp:DropDownList>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                <asp:DropDownList ID="cboCostCenter" runat="server" OnDataBound="cboCostCenter_DataBound" CssClass="form-control">
                </asp:DropDownList>
            </div>
        </div>
        <div class="form-group row">
