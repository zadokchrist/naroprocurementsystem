...
public partial class Bidding_PendingProcurements : System.Web.UI.Page
{
    ...
    private void SubmitProcurements()
    {
        ...
        int Status = 43;
        int PDUSupervisorID = Convert.ToInt32(Session["UserID"].ToString());
        long OfficerID = Convert.ToInt64(Session["UserID"].ToString());
        string PDUSupervisor = Session["FullName"].ToString();
        string returned = Process.SubmitAreaBiddingDetails(ItemArr, OfficerID, Status);
