<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="General_WareHouses.aspx.cs" 
Inherits="CostCenter" 
Title="Cost Center" 
Culture="auto" 
UICulture="auto" %>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            <asp:View ID="View1" runat="server">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">View Warehouses</h6>
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mb-3 mb-sm-0">
                        <label>.</label>
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" class="btn btn-primary btn-user btn-block float-right" Text="Add Ware House" />
                    </div>
                </div>
                <div  class="card-body">
                    <asp:GridView ID="GridCCenter" runat="server" AllowPaging="True" class="table table-bordered table-responsive"
                                DataKeyNames="WarehouseID" EmptyDataText="NO COST CENTER FOUND" HorizontalAlign="Center" 
            ...
            <asp:View ID="View2" runat="server">
                <formview>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3 mb-3 mb-sm-0"><label>Warehouse Name</label></div>
                        <div class="col-sm-3 mb-3 mb-sm-0">
                ...
                <formview>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            <asp:TextBox ID="txtAName" runat="server" CssClass="form-control"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-3 mb-3 mb-sm-0"><label>Area</label></div>
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            <asp:DropDownList ID="cboAreas" runat="server" CssClass="form-control" AutoPostBack="True" class="btn btn-primary btn-user btn-block" >
                                <asp:ListItem Text="-- Select Area --" Value="1"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group row">
