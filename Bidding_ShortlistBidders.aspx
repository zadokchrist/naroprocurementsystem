<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bidding_ShortlistBidders.aspx.cs" Inherits="ShortlistBidders" Title="SHORTLIST OF BIDDERS" %>
        ...
        <tr>
            <td style="text-align: center; vertical-align: middle">
                <table align="center" cellpadding="0" cellspacing="0" style="width: 70%">
                    <tr>
                        <td class="InterfaceHeaderLabel" style="height: 20px">SHORTLIST OF BIDDERS</td>
                    </tr>
                </table>
            </td>
        </tr>
                                    ...
                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 60%; padding-bottom: 0px; padding-top: 0px;">
                                        <tr>
                                            <td class="InterfaceHeaderLabel3" style="height: 17px">
                                                BIDDER SHORTLIST INFORMATION</td>
                                        </tr>
                                    </table>
                                    </td>
                            </tr>
                                                ...
                                                <table align="center" cellpadding="0" cellspacing="0" style="width: 100%">
                                                    <tr>
                                                        <td class="InterfaceHeaderLabel" style="height: 20px">
                                                            ...
                                                            <br />
                                                            <asp:Label ID="Label1" runat="server" ForeColor="#C04000" Text="  ( REQUIRE A MINIMUM OF THREE (3) BIDDERS )"></asp:Label></td>
                                                    </tr>
                                                </table>
                                                <table width="100%">
                                                    <tr>
