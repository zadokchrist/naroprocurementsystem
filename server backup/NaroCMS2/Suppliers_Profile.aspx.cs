...
public partial class Supplier_Profile : System.Web.UI.Page
{
    ...
    private void LoadControls(string Code)
    {
       ...
       TxtFname.Text = Session["Name"].ToString();
        ...
        txtemail.Text = Session["SupplierName"].ToString();
        txtDesignation.Text = "Representative";
        txtphone.Text = "777777777";
        txtAddress.Text = "Lagos";
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        try
        {
          ...
          //  string Disgnation = txtDesignation.Text.Trim();
            ...
            //int reset = IsReset(); string Username = lblUsername.Text;
            ...
            //string returned = Process.UpdateSystemUser(UserCode, Username, FName, MName, LName, Disgnation, Email, Phone, AreaID, CostCenter, IsPDUMember, IsPDUSupervisor, IsInventoryStaff, AccessLevelID, reset, Sign);
