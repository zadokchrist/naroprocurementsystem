...
public partial class Bidding_PendingProcurements : System.Web.UI.Page
{
    ...
    private void SubmitProcurements()
    {
        ...
        int PDUSupervisorID = Convert.ToInt32(cboPDUSupervisors.SelectedValue.ToString());
        long OfficerID = Convert.ToInt64(Session["UserID"].ToString());
        string PDUSupervisor = cboPDUSupervisors.SelectedItem.Text.ToString();
        string returned = Process.SubmitBiddingDetails(ItemArr, PDUSupervisorID, PDUSupervisor, OfficerID, Status);
