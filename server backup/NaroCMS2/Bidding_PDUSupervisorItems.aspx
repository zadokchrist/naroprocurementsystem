<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="Bidding_PDUSupervisorItems.aspx.cs" Inherits="Bidding_PDUSupervisorItems" Title="PROCUREMENT(S) PENDING FOR Procurement Supervisor REVIEW" %>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 60%">
                    <tr>
                        <td class="InterfaceHeaderLabel3" style="height: 18px">
                            PROCUREMENT(S) PENDING FOR PROC MANAGER REVIEW </td>
                    </tr>
                </table>
            </td>
        </tr>
                                        ...
                                        <tr>
                                            <td colspan="4" style="vertical-align: top; position: static; height: 5px; text-align: center">
                                                ...
                                                <asp:Button ID="btnFormDetails" runat="server" Text="View Form Details" 
                                                                ...
                                                                <asp:Button ID="btnViewSolDocs" runat="server" Text="View Docs" OnClick="btnViewSolDocs_Click" />
                                            ...
                                            <td colspan="4" style="vertical-align: top; position: static; height: 5px; text-align: center">
                                                <table align="center" cellpadding="0" cellspacing="0" class="style12">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <%--                     <asp:ListItem Value="43">Approve Procurement</asp:ListItem>
