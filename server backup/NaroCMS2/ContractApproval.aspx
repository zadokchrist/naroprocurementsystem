<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ContractApproval.aspx.cs" Inherits="Contract_Approval" Title="REQUISITION APPROVAL" %>
    ...
    <div class="card shadow mb-4">
        <div class="form-group row">
            ...
            <div class="col-sm-6 mb-3 mb-sm-0">
                ...
                <h6 class="m-0 font-weight-bold text-primary">APPROVE / REJECT REQUISITION</h6>
            </div>
            </div>
        </div>
                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        <asp:View ID="View1" runat="server">
                            <div id="reqy">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2 mb-3 mb-sm-0"></div>
                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                        SERIAL: --&gt;&gt; ( <asp:Label ID="lblEntity" runat="server" Font-Names="cambria" Font-Size="13pt" ForeColor="Red"></asp:Label>)
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2 mb-3 mb-sm-0">
                                        <asp:Label ID="lblWareHouse" runat="server" Visible="False"></asp:Label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-3 mb-3 mb-sm-0">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3 mb-3 mb-sm-0"></div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <asp:Label ID="lblPDDesc" runat="server" Font-Underline="False" Text="."></asp:Label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <asp:GridView ID="GridItems" runat="server" AllowPaging="True"
                                            ...
                                            <RowStyle CssClass="gridRowStyle" VerticalAlign="Top" BackColor="#EFF3FB" />
                                            ...
                                            <asp:MultiView id="MultiView3" runat="server">
                                                <asp:View ID="View4" runat="server">
                                                    <table style="width: 100%">
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: middle; height: 23px; text-align: center">
                                                              <asp:TextBox ID="FCKeditor1" runat="server" TextMode="MultiLine" Visible="false"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </asp:View>
                        ...
                        <asp:View ID="View6" runat="server">
                            <table id="Table3"  style="width: 98%">
                                ...
                                <tr>
                                    <td class="InterFaceTableLeftRowUp" style="width: 100%; height: 21px; text-align: center">
                                        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Export" class="btn btn-primary btn-user btn-block float-right"/>&nbsp;
                                        <asp:Button ID="Button1" runat="server" Text="Return" OnClick="Button1_Click" class="btn btn-primary btn-user btn-block float-right"/></td>
                                </tr>
                                <tr>
                                    <td style="width: 100%; text-align: right">
                                    </td>
                        ...
                        <asp:View ID="View7" runat="server">
                            <table id="Table2" onclick="return TABLE1_onclick()" style="width: 100%">
                                ...
                                <tr>
                                    <td class="InterFaceTableLeftRowUp" style="width: 100%; text-align: center">
                                        <input type="button" onclick="PrintDiv()" value="Print" class="btn btn-primary btn-user btn-block float-right"/>
                                        <asp:Button ID="btnPrint" runat="server" OnClick="btnPrint_Click" Text="Print Form" class="btn btn-primary btn-user btn-block float-right" Visible="false"/>
                                        <asp:Button ID="btnPrintReturn" runat="server" Text="Return" OnClick="btnPrintReturn_Click" class="btn btn-primary btn-user btn-block float-right"/>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td style="width: 100%; text-align: center">
                                    </td>
