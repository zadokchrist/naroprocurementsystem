<%@ Page Language="C#" MasterPageFile="~/PlanningGeneric.master" AutoEventWireup="true" CodeFile="Planning_OperationsAddPlan.aspx.cs" Inherits="Planning_OperationsAddPlan" Title="OPERATIONS - AREA - NEW PLAN ITEM" %>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 50%">
                    <tr>
                        <td class="InterfaceHeaderLabel">
                            <asp:Label ID="lblHeader" runat="server" Text="OPERATIONS - AREA - ADD NEW PLAN ITEM"></asp:Label></td>
                    </tr>
                </table>
            </td>
        </tr>
                            ...
                            <tr>
                                <td class="InterFaceTableRightRowUp" colspan="3" style="height: 10px; text-align: center" valign="middle">
                                    ...
                                    <asp:RadioButton ID="RadioButton1" runat="server" AutoPostBack="True" Checked="True"
                                        GroupName="Budget" OnCheckedChanged="rdOperational_CheckedChanged" Text="Operational Item" Font-Bold="True" Width="151px"  /></td>
                                            <td style="width: 50%; text-align: center">
                                    <asp:RadioButton ID="rdCapital" runat="server" AutoPostBack="True" GroupName="Budget"
                                        OnCheckedChanged="rdCapital_CheckedChanged" Text="Capital Item" Font-Bold="True" Width="116px"  /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
            ...
            <td colspan="3">
                    ...
                    <asp:View ID="View2" runat="server">
                        ...
                        <table align="center" cellpadding="0" cellspacing="0" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td class="InterFaceTableRightRow" style="width: 64%">
                                    <asp:TextBox ID="txtCostCenter" runat="server" autocomplete="off" AutoPostBack="True"
                                        CssClass="InterfaceTextboxLongReadOnly" Font-Bold="True" ForeColor="Firebrick" Width="78%"></asp:TextBox></td>
                            </tr>
                        </table>
                                        ...
                                        </ajaxToolkit:AutoCompleteExtender><ajaxToolkit:AutoCompleteExtender ID="ACECostCenter" runat="server" MinimumPrefixLength="1"
                                            ServiceMethod="GetCostCenters" ServicePath="CascadingddlService.asmx" TargetControlID="txtCostCenter">
                    ...
                    <tr>
                        ...
                        <td class="InterFaceTableRightRow" style="width: 64%; height: 29px">
                            <asp:DropDownList ID="cboPayPeriod" runat="server" CssClass="InterfaceDropdownList"
                                OnDataBound="cboItemCategory_DataBound" Width="82%">
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 95%">
                    ...
                    <tr>
                        ...
                        <td class="InterFaceTableLeftRow" style="height: 29px">
                            Date To Initiate PP20</td>
                        <td class="InterFaceTableMiddleRow" style="width: 2%; height: 29px">
                        </td>
                        <td class="InterFaceTableRightRow" style="width: 64%; height: 29px">
                            <asp:TextBox ID="txtDate4PP20" runat="server" CssClass="InterfaceTextboxLongReadOnly" Width="80%" Enabled="False"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style=" width: 5%; height: 45px">
                        </td>
