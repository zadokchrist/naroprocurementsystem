<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="Bidding_CCProcApproval.aspx.cs" Inherits="Bidding_PendingProcurements" Title="PENDING PROCUREMENT(S)" %>
                                    ...
                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 100%">
                                        ...
                                        <tr>
                                            <td colspan="4" style="vertical-align: top; position: static; height: 5px; text-align: center">
                                                ...
                                                <asp:Label ID="lblECPreviousStatus" runat="server" Text="0"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" style="vertical-align: top; position: static; height: 5px; text-align: center">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                Height="23px" OnClick="btnPrint_Click" Text="Print" Enabled="false" Width="120px" />
                                                    ...
                                                    <asp:View ID="View7" runat="server">
                                                        <table style="width: 100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                Height="23px" OnClick="btnPrintBidders_Click" Text="Print" Enabled= "false" Width="120px" />
                                                        ...
                                                        <table style="width: 100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                Height="23px" OnClick="btnPrintEC_Click" Enabled="false" Text="Print"  Width="120px" />
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="vertical-align: top; height: 42px; text-align: center">
                                                            <table align="center" cellpadding="0" cellspacing="0" style="width: 60%">
                                                                ...
                                                                <tr><asp:Label ID="Label1" runat="server" Font-Names="Cambria" Font-Size="11pt"
                                                                                    ForeColor="Red" Text="NO BIDS FOR THIS PROCUREMENT" Visible="False"></asp:Label> </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <table align="center" cellpadding="0" cellspacing="0" style="width: 95%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="InterFaceTableMiddleRowUp">
                                                                        &nbsp;</td>
                                                                    <td class="InterFaceTableRightRowUp">
                                                                        <asp:RadioButtonList ID="rbnApproval" runat="server" CssClass="InterfaceDropdownList" OnSelectedIndexChanged="rbnApproval_SelectedIndexChanged" AutoPostBack="True">
                                                                            <asp:ListItem Value="45">Approve Procurement</asp:ListItem>
                                                                            <asp:ListItem Value="47">Defer Procurement</asp:ListItem>
                                                                            <asp:ListItem Value="46">Reject/Cancel Procurement</asp:ListItem>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="InterFaceTableRightRowUp">
                                                                        <asp:RadioButtonList ID="rbnSubmission" runat="server" Visible="False" CssClass="InterfaceDropdownList">
                                                                        </asp:RadioButtonList></td>
                                                                </tr>
                                                            </table>
                                                        </td>
