<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="Planning_ExpectedExpenditure.aspx.cs" Inherits="Planning_ExpectedExpenditure" Title="EXPECTED EXPENDITURE" %>
...
<asp:ScriptManager ID="ScriptManager1"  AjaxFrameworkMode="Enabled"  runat="server"></asp:ScriptManager>
    <div class="card shadow mb-4">
        <div class="form-group row">
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                <asp:Label ID="Label1" runat="server" Text="EXPECTED EXPENDITURE FOR THE FINANCIAL YEAR: 2011 - 2012"></asp:Label>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-3 mb-3 mb-sm-0">
        ...
        <div class="form-group row">
            <div class="col-sm-12 mb-3 mb-sm-0">
                <asp:GridView ID="ExpectedExpetiture" runat="server" AllowPaging="True" class="table table-bordered table-responsive"
                     EmptyDataText="NO EXPECTED EXPENDITURE AVAILABLE" HorizontalAlign="Center" OnRowCreated="GridCCenter_RowCreated" OnPageIndexChanging="GridCCenter_PageIndexChanging" CellPadding="4" ForeColor="#333333" GridLines="None">
