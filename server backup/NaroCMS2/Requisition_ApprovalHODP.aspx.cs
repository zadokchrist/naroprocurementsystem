...
public partial class Requisition_ApprovalHOD : System.Web.UI.Page
{
    ...
    private void LoadControls(string RecordID)
    {
        ...
        if ((Session["AccessLevelID"].ToString() == "6" || Session["AccessLevelID"].ToString() == "3") && txtRequisitionType.Text.ToLower().Contains("emergency"))
        ...
        if (Session["AccessLevelID"].ToString() == "3" || Session["AccessLevelID"].ToString() == "9")
        {
    ...
    private void LoadDestinations()
    {
        ...
        {
            dtable = Process.GetProcOfficers();
