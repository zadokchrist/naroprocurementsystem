...
public partial class Requisition_PlannedItems : System.Web.UI.Page
{
    ...
    ProcessBidding Bidding = new ProcessBidding();
    ...
    private void SelectItems()
    {
        ...
        int status = int.Parse(cboProcType.SelectedValue);
        //int supplier = Bidding.GetBidderDetails(supplierid);
     ...
     //   string Quarter = cboQuarters.SelectedValue.ToString();
        ...
        datatable = Bidding.BidderIFBs(supplierid, status);      
    }
        ...
        try
        {
            ...
            if (e.CommandName == "btnPlaceBid")
            {
                ...
                //{
                   ...
                   // StoreSelectedValues();
                    Response.Redirect("Suppliers_PlaceBid.aspx?PR=" + Plancode, false);
               // }
            }
        }
        catch (Exception ex)
