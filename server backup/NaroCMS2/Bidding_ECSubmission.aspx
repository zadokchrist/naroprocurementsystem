<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bidding_ECSubmission.aspx.cs" Inherits="Bidding_ECSubmission" Title="OPEN/RESTRICTED BIDDING PROCUREMENT(S)" %>
        ...
        <tr>
            <td style="height: 39px">
                <table align="center" cellpadding="0" cellspacing="0" style="width: 60%">
                    <tr>
                        <td class="InterfaceHeaderLabel3" style="height: 18px">APPROVED PROCUREMENTS PENDING EVALUATION COMMITTEE APPROVAL</td>
                    </tr>
                </table>
            </td>
        </tr>
                                            ...
                                            <td style="width: 100%">
                                                <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4"  Font-Names="Verdana" Font-Size="Small"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:ButtonColumn CommandName="btnProposeEC" HeaderText="PROPOSE" Text="EC"></asp:ButtonColumn>
                                                        <asp:TemplateColumn HeaderText="ACTION">
                                                            <ItemTemplate>
                                                                <asp:LinkButton runat="server" ID="btnSubmitToCC" CommandName="btnSubmitToCC" Text="Submit To CC" Visible="<%# DisableLink(Container.DataItem) %>"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                                    </Columns>
