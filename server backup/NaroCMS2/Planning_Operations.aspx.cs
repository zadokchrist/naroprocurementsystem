...
using System.IO;
public partial class Planning_Operations : System.Web.UI.Page
{
        ...
        try
        {
            if (IsPostBack == false)
            {
                ...
                if (Request.QueryString["transferid"] != null)
                {
                    ...
                    LoadItems(); DataGrid1.CurrentPageIndex = PageIndex; BindLoadItems();
                }
            }
        }
        catch (Exception ex)
    ...
    private void LoadItems()
    {
        ...
        dtable = Process.GetPlanItemsForOperations(Search, ProcTypeCode, CostCenterID);
    }
    ...
    private void SubmitPlanItems()
    {
        ...
        {
            ShowMessage("Please Provide A Reason For Deletion Of Selected Plan Items");
        }
        else
        {
            ...
            if (ItemArr != "")
            {
                string returned = Process.DeletePlanItems(ItemArr, 35, txtComment.Text, 2);
                ResetControls();
    ...
    protected void DataGrid1_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        try
        {
            ...
            Session["PreviousPage"] = "Planning_Operations.aspx";
