<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="General_Years1.aspx.cs" Inherits="General_Years"
                    ...
                    <tr>
                        <td style="vertical-align: top; width: 50%; height: 2px; text-align: center">
                            <table align="center" cellpadding="0" cellspacing="0" style="width: 55%">
                                ...
                                <tr>
                                    <td colspan="3" style="vertical-align: middle; height: 19px; text-align: center">
                                        &nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Add Financial Years" /></td>
                                </tr>
                                <tr>
                                    <td colspan="3" style="vertical-align: middle; height: 19px; text-align: center">
                                    </td>
                        ...
                        <td style="text-align: center; vertical-align: top; width: 50%">
                            ...
                            <asp:GridView ID="GridData" runat="server" AllowPaging="True" CssClass="gridgeneralstyle"
                                DataKeyNames="Code" EmptyDataText="NO ITEM(S) FOUND" HorizontalAlign="Center" 
                                 PageSize="11" Width="80%" OnRowCommand="GridData_RowCommand" BorderStyle="Solid" OnPageIndexChanging="GridData_PageIndexChanging">
                        ...
                        <table align ="center" cellpadding="0" cellspacing="0" style="width: 55%">
                            ...
                            <tr>
                                ...
                                <td class="InterFaceTableRightRow" style="height: 29px">
                                    <asp:TextBox ID="txtStartDate" runat="server" Style="width: 70%" Width="124px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                ...
                                <td class="InterFaceTableRightRow">
                                    <asp:TextBox ID="txtEndDate" runat="server" CssClass="InterfaceTextboxLongReadOnly"
                            ...
                            <tr>
                                ...
                                Text="Return" Width="85px" OnClick="btnCancel_Click" /></td>
                            </tr>
                            <tr>
