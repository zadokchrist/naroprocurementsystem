<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="AssignProcMethods.aspx.cs" Inherits="Requisition_Approval" Title="REQUISITION APPROVAL" %>
                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        ...
                        <asp:View ID="View7" runat="server">
                            <table id="Table2" onclick="return TABLE1_onclick()" style="width: 100%">
                                ...
                                <tr>
                                    <td class="InterFaceTableLeftRowUp" style="width: 100%; text-align: center">
                                        <asp:Button ID="btnPrint" runat="server" OnClick="btnPrint_Click" Text="Print Form" class="btn btn-primary btn-user btn-block float-right"/>
