<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Requisition_ApprovalMD.aspx.cs" Inherits="Requisition_ApprovalMD" Title="REQUISITION APPROVAL" %>
                                            ...
                                            <tr>
                                                <td style="text-align: center; vertical-align: top; width: 50%;">
                                                    <table align ="center" cellpadding="0" cellspacing="0" style="width: 95%">
                                                        ...
                                                        <tr>
                                                            <td class="InterFaceTableLeftRowUp">
                                                                <asp:Label ID="lblDestination" runat="server" Text="Destination" Visible="false"></asp:Label></td>
                                                            <td class="InterFaceTableMiddleRowUp">
                                                            </td>
                                                            <td class="InterFaceTableRightRowUp">
                                                                <asp:DropDownList ID="cboSendTo" runat="server" OnDataBound="cboSendTo_DataBound"
                                                                    Width="80%" OnSelectedIndexChanged="cboSendTo_SelectedIndexChanged" Visible="false">
                                                                </asp:DropDownList></td>
                                                            <td>
