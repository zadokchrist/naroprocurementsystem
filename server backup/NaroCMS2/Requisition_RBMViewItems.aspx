<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Requisition_RBMViewItems.aspx.cs" Inherits="Requisition_RBMViewItems" Title="REQUISITION ITEM(S)" %>
    ...
    <table cellpadding="0" cellspacing="0" class="style12">
        ...
        <tr>
            <td style="vertical-align: top; width: 50%; text-align: center">
                ...
                <asp:Label ID="lblPDCode" runat="server" Text="0" Visible="False"></asp:Label></td>
        </tr>
    </table>
