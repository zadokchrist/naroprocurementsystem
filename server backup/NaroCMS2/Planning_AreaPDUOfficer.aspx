<%@ Page Language="C#" MasterPageFile="~/PlanningGeneric.master" AutoEventWireup="true" CodeFile="Planning_AreaPDUOfficer.aspx.cs" Inherits="Planning_AreaPDUOfficer" Title="AREA PLAN ITEMS" %>
                                        ...
                                        <tr>
                                            ...
                                            <td class="InterFaceTableRightRowUp" style="height: 25px">
                                                <asp:RadioButtonList ID="rbnApproval" runat="server" CssClass="InterfaceDropdownList">
                                                    <asp:ListItem Value="1">Consolidate and Forward To Procurement Manager</asp:ListItem>
