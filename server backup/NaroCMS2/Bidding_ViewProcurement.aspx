<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="Bidding_ViewProcurement.aspx.cs" Inherits="Bidding_ViewProcurement" Title="SEARCH PROCUREMENT(S)" %>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mb-3 mb-sm-0">
                        ...
                        <asp:DropDownList ID="cboStatus" runat="server" CssClass="form-control">
                            ...
                            <asp:ListItem Value="43" Text="Proc Method approved"></asp:ListItem>
                            <asp:ListItem Value="42" Text="Proc Method rejected"></asp:ListItem>
                            <asp:ListItem Value="50" Text="Bid sourcing approved"></asp:ListItem>
                            <asp:ListItem Value="52" Text="Bid sourcing closed"></asp:ListItem>
                            <asp:ListItem Value="53" Text="Bid opening"></asp:ListItem>
                            <asp:ListItem Value="63" Text="Evaluation completed"></asp:ListItem>
                    ...
                    <div class="col-sm-12 mb-3 mb-sm-0">
                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4" Font-Names="Verdana" Font-Size="Small"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="Subject" ItemStyle-CssClass="gridPad" HeaderText="Subject"></asp:BoundColumn>
