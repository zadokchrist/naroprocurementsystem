<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bidding_PreBidMeeting.aspx.cs" Inherits="Bidding_PreBidMeeting" Title="PRE-BID MEETING" %>
                                                        ...
                                                        <tr>
                                                            <td style="width: 100%; text-align: center">
                                                                <table align="center" cellpadding="0" cellspacing="0" style="margin-top: 10px; width: 60%">
                                                                    <tr>
                                                                        <td class="InterfaceHeaderLabel3" style="height: 17px">
                                                                            ADD PRE-BID MEETING DETAILS</td>
                                                                    </tr>
                                                                </table>
                                                                <br />
                                                                <table align="center" cellpadding="0" cellspacing="0" class="style12">
                                                                    ...
                                                                    <tr style="color: #000000">
                                                                        <td colspan="2" style="vertical-align: top; height: 19px; text-align: center">
                                                                            <asp:Button ID="btnSubmitMeeting" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px"
                                                                                            OnClick="btnSubmitMeeting_Click" Text="SAVE MEETING" ToolTip="Hide this section" Width="144px" />
                                                                    ...
                                                                    <tr style="color: #000000">
                                                                        <td colspan="2" style="vertical-align: top; height: 19px; padding-top:5px; text-align: center">
                                                                            <asp:Button ID="btnfinalSubmitmeeting" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px"
                                                                                            OnClick="btnfinalSubmitmeeting_Click" Text="SUBMIT MEETING" ToolTip="Hide this section" Width="144px" />
                                                    ...
                                                    <table style="width: 100%"><tr>
                                                        <td style="width: 100%; text-align: center">
                                                            <table align="center" cellpadding="0" cellspacing="0" style="margin-top: 10px; width: 60%">
                                                                <tr>
                                                                    <td class="InterfaceHeaderLabel3" style="height: 17px">
                                                                        ADD RECORD OF PRE-BID MEETING </td>
                                                                    </tr>
                                                                </table>
                                                                <br />
                                                                <table align="center" cellpadding="0" cellspacing="0" class="style12">
                                                                            ...
                                                                            <table align="center" cellpadding="0" cellspacing="0" style="border-right: #a4a2ca 1px solid;
                                                                                ...
                                                                                <tr>
                                                                                    <td style="height: 19px">
                                                                                        ...
                                                                                        <p>
                                                                                            <input id="ButtonAdd" onclick="addFileUploadBox()" type="button" value="Add a file" onclick="return ButtonAdd_onclick()" onclick="return ButtonAdd_onclick()" />
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                    ...
                                                    <table style="width: 100%"><tr>
                                                        <td style="width: 100%; text-align: center">
                                                            <table align="center" cellpadding="0" cellspacing="0" style="margin-top: 10px; width: 60%">
                                                                <tr>
                                                                    <td class="InterfaceHeaderLabel3" style="height: 17px">
                                                                        ADD RECORD OF PRE-BID MEETING ATTENDENCE </td>
                                                                    </tr>
                                                                </table>
                                                                <br />
                                                                <table align="center" cellpadding="0" cellspacing="0" class="style12">
                                                                    ...
                                                                    <tr style="color: #000000">
                                                                        <td colspan="2" style="margin: 0px; vertical-align: top; height: 5px; text-align: center">
                                                                            <asp:Label ID="lblMsg3" runat="server" ForeColor="Red" Text="."></asp:Label></td>
                                                                    </tr>
                                                                    <tr style="color: #000000">
                                                                        <td colspan="2" style="vertical-align: top; text-align: center">
                                                                            <table align="center" cellpadding="0" cellspacing="0" class="style12">
                                                                                <tr>
                                                                                    <td style="vertical-align: top; width: 45%; text-align: center">
                                                                                                    ...
                                                                                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td class="InterFaceTableMiddleRowUp" style="width: 2%">
                                                                                                                &nbsp;</td>
                                                                                                            <td class="InterFaceTableRightRowUp">
                                                                                                                <asp:TextBox ID="txtnameAndAddress" runat="server" autocomplete="off" Font-Bold="False"
                                                                                                                    Style="height: 55px" TextMode="MultiLine" Width="95%"></asp:TextBox></td>
                                                                                                        </tr>
                                                                                                    </table>
                                                                                                </td>
                                                                                        ...
                                                                                        &nbsp;
                                                                                        <asp:Label ID="lblPreBidMeetingIDQ1" runat="server" Text="0" Visible="False"></asp:Label></td>
                                                                                    <td style="vertical-align: top; width: 45%; color: #000000; text-align: center">
                                                                                        <table align="center" cellpadding="0" cellspacing="0" style="width: 95%">
                                                                                        </table>
                                                                                        <table cellpadding="0" cellspacing="0" class="style12" style="width: 95%">
                                                                                                    ...
                                                                                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 100%; height: 55px">
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td class="InterFaceTableMiddleRowUp" style="width: 2%">
                                                                                                                &nbsp;</td>
                                                                                                            <td class="InterFaceTableRightRowUp">
                                                                                                                <asp:TextBox ID="txtCompany" runat="server" Width="80%"></asp:TextBox></td>
                                                                                                        </tr>
                                                                                                    </table>
                                                                                                    &nbsp;</td>
                                                                                            </tr>
                                                                    ...
                                                                    <tr style="color: #000000">
                                                                        <td colspan="2" style="vertical-align: top; text-align: center">
                                                                            <asp:Button ID="btnAddMeetingAttendance" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px" Text="Add Meeting Attendance" Width="214px" OnClick="btnAddMeetingAttendance_Click" /></td>
                                                                    </tr>
                                                                    <tr style="color: #000000">
                                                                        <td colspan="2" style="vertical-align: top; text-align: center">
                                                                        </td>
                                                                        ...
                                                                        <td colspan="2" style="vertical-align: top; height: 19px; text-align: center">
                                                                            <asp:DataGrid ID="DataGrid3" runat="server" AutoGenerateColumns="False" CellPadding="4"  Font-Names="Verdana" Font-Size="Small"
                                                                                ...
                                                                                <Columns>
                                                                                    <asp:BoundColumn DataField="ID" HeaderText="ID" Visible="False" />
                                                                                    <asp:BoundColumn DataField="PreBidMeetingID" HeaderText="PreBidMeetingID" Visible="False" />
                                                                                    <asp:BoundColumn DataField="NameAndAddress" HeaderText="Name And Address" />
                                                                                    <asp:BoundColumn DataField="Position" HeaderText="Position" />
                                                                                    <asp:BoundColumn DataField="companyordepartment" HeaderText="Company or Department" />
                                                                                    <asp:ButtonColumn CommandName="btnEdit" HeaderText="Edit" Text="Edit" />
                                                                                    <asp:ButtonColumn CommandName="btnRemove" HeaderText="Remove" Text="Remove" >
                                                                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                                                                            Font-Underline="False" ForeColor="Red" />
                                                                            ...
                                                                            <asp:Label ID="lblNoAttendance" runat="server" Font-Bold="True" Font-Names="Cambria" ForeColor="Red"
                                                                                Visible="False" Width="70%">NO PRE-BID MEETING ATTENDEES CURRENTLY AVAILABLE</asp:Label></td>
                                                                    </tr>
                                                                    <tr style="color: #000000">
                                                                        <td colspan="2" style="vertical-align: top; height: 19px; text-align: center">
                                                                        </td>
                                                                    ...
                                                                    <tr style="color: #000000">
                                                                        <td colspan="2" style="vertical-align: top; height: 19px; text-align: center">
                                                                            <asp:Button ID="btnSubmitAttendance" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px"
                                                                                            OnClick="btnSubmitAttendance_Click" Text="SUBMIT ATTENDANCE" ToolTip="Hide this section" Width="236px" />
                                                                            
                                                                            <asp:Button ID="Button5" runat="server" Font-Bold="True" Font-Size="9pt" Height="23px" Text="CANCEL" ToolTip="Hide this section" Width="120px" OnClick="btnCancelQuestion_Click" /></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
