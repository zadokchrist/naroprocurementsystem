<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="Requisition_FinanceViewFramework.aspx.cs" Inherits="Requisition_FinanceViewItems" Title="VIEW REQUISITION(S)" %>
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td class="InterFaceTableLeftRowUp" style="width: 100%; text-align: center">
                                               FRAMEWORK CONTRACT REQUISITION(S) SENT TO YOU FOR FUND APPROVAL</td>
                                        </tr>
                                        <tr>
