<%@ Page Language="C#" MasterPageFile="~/GenericMasterPage.master" AutoEventWireup="true" CodeFile="SumarryReport.aspx.cs" Inherits="SumarryReport" Title="View Procurements" %>
                ...
                <tr>
                    <td style="width: 100%; text-align: center">
                        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" CellPadding="4" HorizontalAlign="Left" Font-Names="Verdana" Font-Size="Small"
                            ...
                            <Columns>
                                <asp:BoundColumn DataField="ScalaPRNumber" HeaderText="ID"></asp:BoundColumn>
                                <asp:BoundColumn DataField="PD_EntityCode" HeaderText="Reference Number"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn DataField="CreationDate" HeaderText="Date opened">
                                    <ItemStyle Width="120px" HorizontalAlign="Left" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="STATUS" HeaderText="Status">
                                    <ItemStyle Width="120px" HorizontalAlign="Left" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="CountDown" HeaderText="Remaing Time">
                                    <ItemStyle Width="120px" HorizontalAlign="Left" />
                                </asp:BoundColumn>
                                <asp:ButtonColumn CommandName="btnDetails" HeaderText="Details" Text="VIEW BID DETAILS">
                                    <ItemStyle Font-Bold="True" />
                                </asp:ButtonColumn>
                                <asp:ButtonColumn CommandName="btnPlaceBid" HeaderText="Respond" Text="RESPOND">
                                    <ItemStyle Font-Bold="True" />
                                </asp:ButtonColumn>
                            </Columns>
