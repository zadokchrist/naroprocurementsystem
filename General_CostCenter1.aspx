...
AutoEventWireup="true" CodeFile="General_CostCenter1.aspx.cs" 
Inherits="CostCenter" 
Title="Cost Center" 
Culture="auto" 
UICulture="auto" %>
                            ...
                            <table align ="center" cellpadding="0" cellspacing="0" style="width: 55%">
                                ...
                                <tr>
                                    ...
                                    <td class="InterFaceTableRightRowUp">
                                        <asp:DropDownList ID="cboAreas" runat="server" CssClass="InterfaceDropdownList"
                                            ...
                                            Width="60%" style="width: 70%" AutoPostBack="True" OnSelectedIndexChanged="cboAreas_SelectedIndexChanged">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="3" style="vertical-align: middle; text-align: center; height: 19px;">
                                        &nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Add Cost Center" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                ...
                                <td class="InterFaceTableLeftRowUp">
                                    ...
                                    <td class="InterFaceTableRightRowUp">
                                        <asp:DropDownList ID="cboCompany" runat="server" CssClass="InterfaceDropdownList"
                                            OnDataBound="cboCompany_DataBound"
                                            Width="60%" style="width: 70%" AutoPostBack="True">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="InterFaceTableRightRow" style="height: 30px">
                                        <asp:TextBox ID="txtCcCode" runat="server" style="width: 70%" Width="124px" ReadOnly="True"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="InterFaceTableRightRow" style="height: 29px">
                                        <asp:TextBox ID="txtCCenter" runat="server" style="width: 70%"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="InterFaceTableLeftRow">
                                        Cost Center Initial</td>
                                    <td class="InterFaceTableMiddleRow">
                                    </td>
                                    <td class="InterFaceTableRightRow">
                                        <asp:TextBox ID="txtCCIntial" runat="server" CssClass="InterfaceTextboxLongReadOnly"
                                            Width="60%" style="width: 70%"></asp:TextBox></td>
                                </tr>
                            <tr>
                                <td class="InterFaceTableLeftRow">
                                ...
                                <td class="InterFaceTableRightRow">
                                    <asp:CheckBox ID="CheckBox4" runat="server" Font-Bold="True" Text="Is Multi Cost Center" /></td>
                            </tr>
                            <tr>
                                <td class="InterFaceTableLeftRow">
                                    Active/De-active</td>
                                ...
                                <td class="InterFaceTableRightRow">
                                    <asp:CheckBox ID="CheckBox1" runat="server" Font-Bold="True" Text="Active" /></td>
                            </tr>
                                <tr>
                        ...
                        <table align ="center" cellpadding="0" cellspacing="0" style="width: 55%">
                            ...
                            <tr>
                                ...
                                <td class="InterFaceTableRightRowUp" style="height: 30px">
                                    <asp:DropDownList ID="cboCategory" runat="server" CssClass="InterfaceDropdownList"
                                            OnDataBound="cboCategory_DataBound"
                                            Width="60%" style="width: 70%" AutoPostBack="True" OnSelectedIndexChanged="cboCategory_SelectedIndexChanged">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr>
                                <td class="InterFaceTableLeftRowUp" style="height: 30px">
                                ...
                                <td class="InterFaceTableMiddleRowUp" style="height: 30px">
                                    &nbsp;</td>
                                <td class="InterFaceTableRightRowUp" style="height: 30px">
                                    <asp:DropDownList ID="cboCompany2" runat="server" CssClass="InterfaceDropdownList"
                                            OnDataBound="cboCompany2_DataBound"
                                            Width="60%" style="width: 70%" AutoPostBack="True">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr>
                                ...
                                <td class="InterFaceTableRightRow" style="height: 30px">
                                 <asp:TextBox ID="cboCostCenterNames" Style="width: 70%" Width="60%" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td class="InterFaceTableLeftRow" style="height: 29px">
                                    Cost Center Code</td>
                                <td class="InterFaceTableMiddleRow" style="height: 29px">
                                    &nbsp;</td>
                                <td class="InterFaceTableRightRow" style="height: 29px">
                                    <asp:TextBox ID="txtCode" runat="server" Style="width: 70%" Width="60%"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td class="InterFaceTableLeftRow">
                                    Cost Center Initial</td>
                                ...
                                <td class="InterFaceTableRightRow">
                                    <asp:TextBox ID="txtInitial" runat="server" CssClass="InterfaceTextboxLongReadOnly"
                            ...
                            <tr>
                                ...
                                <td class="InterFaceTableRightRow">
                                    <asp:CheckBox ID="CheckBox3" runat="server" Font-Bold="True" Text="Is Multi Cost Center" /></td>
                            </tr>
                            <tr>
                                <td class="InterFaceTableLeftRow">
                                    Active/De-active</td>
